...
То есть полностью аналогичная описанному в [документации библиотеки **requests** в разделе **session** главы proxy](https://requests.readthedocs.io/en/latest/user/advanced/#proxies).
